...
Version  : 0.09
Release  : 18
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Test-Refcount-0.09.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Test-Refcount-0.09.tar.gz
...
%prep
%setup -q -n Test-Refcount-0.09
cd ..
%setup -q -T -D -n Test-Refcount-0.09 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Test-Refcount-0.09/deblicense/
